        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        <x-dropdown-link href="{{ route('web-apps.index') }}">
                        Web Apps
                        </x-dropdown-link>
                        @endcan
                        ...
                        <x-dropdown-link href="{{ route('databases.index') }}">
                        Databases
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\EmailAccount::class)
                        <x-dropdown-link href="{{ route('email-accounts.index') }}">
                        Email Accounts
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\FtpAccount::class)
                        <x-dropdown-link href="{{ route('ftp-accounts.index') }}">
                        Ftp Accounts
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\SshAccess::class)
                        <x-dropdown-link href="{{ route('ssh-accesses.index') }}">
                        Ssh Accesses
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @can('view-any', App\Models\WebApp::class)
                <x-responsive-nav-link href="{{ route('web-apps.index') }}">
                Web Apps
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Domain::class)
                <x-responsive-nav-link href="{{ route('domains.index') }}">
                Domains
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Database::class)
                ...
                @endcan
                @can('view-any', App\Models\EmailAccount::class)
                <x-responsive-nav-link href="{{ route('email-accounts.index') }}">
                Email Accounts
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\FtpAccount::class)
                <x-responsive-nav-link href="{{ route('ftp-accounts.index') }}">
                Ftp Accounts
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\SshAccess::class)
                <x-responsive-nav-link href="{{ route('ssh-accesses.index') }}">
                Ssh Accesses
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
